...
@section('content')
    <div class="row-fluid">
        <div class="panel panel-primary">
            ...
            <form class="form-horizontal" role="form" method="post" action="{{ route('paciente.atualizar') }}">
                {{ csrf_field() }}
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm" name="pes_nome" id="pes_nome" placeholder="Primeiro Nome" value="{{ $paciente->pes_nome }}" >
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm" name="pes_rg" id="pes_rg" value="{{ old('pes_rg') }}">
