        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">
                    Atualização de Dados de Médico
                </h3>
            </div><br/>
            <form class="form-horizontal" role="form" method="post" action="{{ route('medico.atualizar') }}">
                {{ csrf_field() }}
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="hidden" class="form-control input-sm" name="id_pessoa" id="id_pessoa" value="{{ $medico->id_pessoa }}">
                                <input type="text" class="form-control input-sm" name="pes_cpf" id="cpf" placeholder="CPF" value="{{ $medico->pes_cpf }}" >
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm" name="pes_nome" id="pes_nome" placeholder="Primeiro Nome" value="{{ $medico->pes_nome }}" >
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control input-sm" name="email" id="email" value="{{ $medico->email }}">
